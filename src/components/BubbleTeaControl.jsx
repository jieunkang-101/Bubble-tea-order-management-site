  ...
  setVisibility  = () => {
    if (this.state.selectedBubbleTea != null) {
      return {
        ...
        // order: this.state.selectedBubbleTea.quantity > 0 ? <BubbleTeaDetail bubbleTea = {this.state.selectedBubbleTea}onSellingTea={this.handleSellTea}   onRestockingTea={this.handleRestockTea}/> : <BubbleTeaDetail bubbleTea = {this.state.selectedBubbleTea.message += 'out of stock'}  />
        order:  <BubbleTeaDetail bubbleTea = {this.state.selectedBubbleTea} onSellingTea={this.handleSellTea}  onRestockingTea={this.handleRestockTea}/>
      }
